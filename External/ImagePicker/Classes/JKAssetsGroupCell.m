...
- (UIView *)checkImageView
{
    if (!_checkImageView) {
        _checkImageView = [[UIView alloc] initWithFrame:CGRectMake(CGRectGetWidth(self.thumbnailView.frame) - 16.f, CGRectGetHeight(self.thumbnailView.frame) - 16.f, 13.f, 13.f)];
        [_checkImageView setBackgroundColor:FOREGROUND_COLOR];
        [_checkImageView.layer setCornerRadius:6.5f];
        [_checkImageView setClipsToBounds:YES];
