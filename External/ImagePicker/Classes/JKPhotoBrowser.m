...
//        NSString  *str = [NSString stringWithFormat:@"%@%lu%@",LBLocalized(@"Most choose"),(unsigned long)self.pickerController.maximumNumberOfSelection,LBLocalized(@"pictures")];
...
//    
//    cell.asset = [self.assetsArray objectAtIndex:indexPath.item];
//    return cell;
//    
//}
//
...
//        UIImage  *img1 = [UIImage imageNamed:@"chk_unselected"];
//        UIImage  *imgH = [UIImage imageNamed:@"chk_selected"];
